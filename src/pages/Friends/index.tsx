...
import { saveFriendsUrlData } from '../../redux/slices/appSlice';
              ...
              >
                <div className="friends-card">
                  ...
                  <div className="friends-card-content">
                    <div
                      className={
                        darkMode ? 'friends-card-content-title-dark' : 'friends-card-content-title'
                      }
                    >
                      {item.title}
                    </div>
                    ...
                    <div
                      className={
                        darkMode
                          ? 'friends-card-content-description-dark'
                          : 'friends-card-content-description'
                      }
                    >
                      {item.description}
                    </div>
    ...
    <div className="page-main">
      ...
      <div className="page-main-content">
        <Card darkMode={darkMode}>
          <div className="friends-main">{createFriendsUrlCards()}</div>
        </Card>
      </div>
    </div>
  );
